...
const Hero2 = ({
  ...
  const handleScroll = () => {
    ...
    if (starsRef2.current) {
      const scrollPosition = window.scrollY;
      const scale = 1.1 - scrollPosition / 3000; // Adjust the divisor to control the zoom speed
      starsRef2.current.style.transform = `scale(${scale})`;
    }
  };
  ...
  return (
    <section className="parallax">
      <div className="parallax__content absolute top-[4%] sm:top-[10%] lg:top-[16%] w-full md:mx-auto lg:pl-[38vh] lg:pr-[30vh] xl:pl-96 xl:pr-72 2xl:px-40 3xl:px-60 flex flex-col lg:flex-row items-start z-10">
      ...
      <img
        ref={starsRef2}
        className="parallax__stars lg:hidden scale-110"
      ...
      <div
        ref={starsRef}
        className="parallax__monster w-screen h-screen hidden lg:block scale-150 fixed top-0 left-0"
      >
        <Monster />
      </div>
