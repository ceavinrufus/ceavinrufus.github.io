...
export const gridItems = [
  ...
  },
  {
    ...
    imgClassName: "absolute right-0 bottom-0 h-2/3 lg:h-1/2",
    titleClassName: "justify-start lg:-translate-y-3",
    img: "/image.png",
    spareImg: "",
  },
...
export const projects = [
  ...
  },
  {
    id: 3,
    title: "Decarbond",
    des: "A software to plan, design, simulate, monitor, and optimize decarbonization project.",
    img: "/decarbond.png",
    iconLists: ["/next.svg", "/tail.svg", "/ts.svg", "/shadcn.svg"],
    link: "https://decarbond.vercel.app/",
    github: "https://github.com/ceavinrufus/decarbond",
  },
  // {
  //   id: 4,
  //   title: "Krypt",
  ...
  //   ],
  //   // link: "",
  //   github: "https://github.com/ceavinrufus/krypt/",
  // },
  // {
  //   id: 5,
...
export const services = [
  {
    ...
    desc: "Building scalable web applications with modern frameworks like Next.js, React, and Node.js, delivering end-to-end solutions from concept to deployment.",
  ...
  },
  {
    ...
    desc: "Creating cross-platform mobile applications using React Native and Flutter, focusing on performance and user experience.",
    className: "md:col-span-2",
    thumbnail: "/exp2.svg",
  },
  {
    ...
    desc: "Developing intelligent SaaS applications with AI integration, payment systems, and modern tech stacks for business automation.",
    className: "md:col-span-2",
    thumbnail: "/exp3.svg",
  },
  {
    ...
    desc: "Building decentralized applications and smart contracts, exploring blockchain technologies and cryptocurrency integrations.",
    className: "md:col-span-2",
    thumbnail: "/exp4.svg",
  },
];
